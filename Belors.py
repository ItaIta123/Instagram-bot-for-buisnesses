...
webdriver_path = '/Users/itamarfayler/Computer Science/chromedriver 2'
...
if __name__ == "__main__":
    ...
    hashtag_likes(hashtag="#jewelry", likes_num=50, follow=False)
